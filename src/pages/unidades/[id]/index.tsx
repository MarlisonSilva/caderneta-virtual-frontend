  ...
  return (
    <div className="flex min-h-screen bg-[#f7f6fc] text-[#1e1e2f]">
      ...
      <main className="flex-1 p-10 ml-64">
        ...
        <h1 className="text-2xl font-bold mb-6">Detalhes da Unidade</h1>
        ...
        <div className="flex justify-end mt-8 gap-4">
          <button
            onClick={() => router.push(`/unidades/${id}/editar`)}
          ...
          <button
            onClick={async () => {
              try {
                ...
                setShowConfirm(false);
                router.push("/unidades"); // volta pra lista
              } catch (err) {
